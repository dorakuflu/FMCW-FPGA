...
#
# Script generated by Vivado on Wed Jul 24 15:03:45 +0300 2024
...
#
# Usage        : FFT1.sh
#                FFT1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FFT1.sh [-reset_run]
#                FFT1.sh [-reset_log]
#                FFT1.sh [-help]
#
...
#                script (type 'FFT1.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FFT1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.FFT1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.FFT1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log FFT1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FFT1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FFT1.sh [-help]\n\
Usage: FFT1.sh [-step]\n\
Usage: FFT1.sh [-lib_map_path]\n\
Usage: FFT1.sh [-reset_run]\n\
Usage: FFT1.sh [-reset_log]\n\
Usage: FFT1.sh [-keep_index]\n\
Usage: FFT1.sh [-noclean_files]\n\n\
