...
HD_PWD='C:/Users/kuflu/Vivado/VivadoProjects/FMCW/FMCW.runs/FFT0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT0.tcl
